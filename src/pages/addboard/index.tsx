  ...
  return (
    <>
      ...
      <MainLayout>
        ...
        <form className="mt-6">
          <h1 className="mb-3 text-sm font-bold md:text-lg">*제목</h1>
          <TextInput placeholder="제목을 입력해주세요" />

          <h1 className="mb-3 mt-6 text-sm font-bold md:text-lg">*내용</h1>
          <TextInput placeholder="내용을 입력해주세요" />

          <h1 className="mb-3 mt-6 text-sm font-bold md:text-lg">이미지</h1>
